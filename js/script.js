...
const appendPageLinks = (list) => {
   ...
   for (let i = 0; i < anchors.length; i++) {// This is the for loop and it will loop through the anchors
      anchors[i].addEventListener('click', (event) => {// This is the event listener and when the click is pressed by user the event will listen for the click.
         ...
         event.target.className = "active";// set event target class name to active
